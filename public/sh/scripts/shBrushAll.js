...
SyntaxHighlighter.brushes.Go.aliases   = ['go', 'Go'];
...
SyntaxHighlighter.brushes.Lisp.aliases   = ['scheme', 'racket', 'lisp', 'Scheme', 'Racket', 'Lisp'];
...
SyntaxHighlighter.brushes.Python.aliases    = ['python', 'Python'];
