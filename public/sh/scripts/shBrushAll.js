...
SyntaxHighlighter.brushes.Lisp.aliases   = ['lisp', 'Lisp', 'cl', 'commonlisp', 'CommonLisp'];
...
SyntaxHighlighter.brushes.Lisp.prototype = new SyntaxHighlighter.Highlighter();
SyntaxHighlighter.brushes.Lisp.aliases   = ['newlisp', 'newLisp', 'nl'];
...
(function () {
    ...
    Brush.prototype = new SyntaxHighlighter.Highlighter();
    Brush.aliases = ['sass', 'scss', 'Sass', 'Scss'];
